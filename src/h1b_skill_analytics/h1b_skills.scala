...
Skills_h1b.coalesce(1).write.option("header","true").option("sep",",").format("csv").save("final_project/data/Skills_h1b2.csv")
...
CC_h1b.coalesce(1).write.option("header","true").option("sep",",").format("csv").save("final_project/data/CC_h1b2.csv")
// CC_h1b.show(false)
// +------+---------+                                                              
// |Skills|h1bCount |
// +------+---------+
...
BD_h1b.coalesce(1).write.option("header","true").option("sep",",").format("csv").save("final_project/data/BD_h1b2.csv")
// +-------------+--------+                                                        
// |Skills       |h1bCount|
// +-------------+--------+
// |MapReduce    |655.125 |
...
Docker_h1b.coalesce(1).write.option("header","true").option("sep",",").format("csv").save("final_project/data/Docker_h1b2.csv")
// +----------+--------+                                                           
// |Skills    |h1bCount|
// +----------+--------+
// |Docker    |1349.0  |
...
DB_h1b.coalesce(1).write.option("header","true").option("sep",",").format("csv").save("final_project/data/DB_h1b.csv")
// +----------+--------+                                                           
// |    Skills|h1bCount|
// +----------+--------+
// |   MongoDB| 1860.75|
...
backend_h1b.coalesce(1).write.option("header","true").option("sep",",").format("csv").save("final_project/data/backend_h1b.csv")
// +----------+--------+                                                           
// |    Skills|h1bCount|
// +----------+--------+
// |   Node.JS|5362.875|
...
frontend_h1b.coalesce(1).write.option("header","true").option("sep",",").format("csv").save("final_project/data/frontend_h1b.csv")
// +--------------------+--------+                                                 
// |              Skills|h1bCount|
// +--------------------+--------+
...
MLDL_h1b.coalesce(1).write.option("header","true").option("sep",",").format("csv").save("final_project/data/MLDL_h1b.csv")
// +------------+--------+                                                         
// |      Skills|h1bCount|
// +------------+--------+
// |     Pytorch|2038.875|
